...
<body class="animsition">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="${pageContext.request.contextPath}/mainProduct/selectMainWomanGoods.do" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="${pageContext.request.contextPath}/mainProduct/selectMainManGoods.do" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									ReCloset
								</span>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="${pageContext.request.contextPath}/mainProduct/selectMainAcGoods.do" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									Newtro
								</span>
		...
		<div class="container">
			...
			<c:forEach items="${goods}" var="goods">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 ${ goods.categoryCode == 1 ? 'Item' : goods.categoryCode == 2 ? 'acc' : goods.categoryCode == 3 ? 'woman' : goods.categoryCode == 4 ? 'men' : 'etc' }">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0" style="height : 320px;">
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				...
				<button id="shopNowBtn" type="button" onclick="moveProductList();">
	...
	function moveProductList(){
		location.replace("${pageContext.request.contextPath}/product/productList.do");	
	}
	...
	$(function(){
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/mainProduct/selectMainAllGoods.do",
