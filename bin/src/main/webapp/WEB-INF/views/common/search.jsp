...
<div>
	<form class="form-inline" method="post" id="searchForm">
		<div id="searchFormstyle" style="/* display: flow-root; width: 150px; */padding: 10px;">
		<div class="form-inline" style="display: inline-flex;margin-left: 120px;">
			<select class="form-control" id="categorySearch" name="category" padding-left = "200px;">
		   ...
		   <!--  <div class="bor17 of-hidden pos-relative">
			...
			<div class="bor17 of-hidden pos-relative" style="
	    margin-right:  40px;">
		...
		<div id="searchRankForm" style="display: inline-flex;margin-left: 600px;">
    <div class="bor17 of-hidden pos-relative" id="searchRankBackground" style="
